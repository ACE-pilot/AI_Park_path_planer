...
# Load the loss data
file_path = 'E:/project/AI_Designer/PARL_01/examples/MADDPG_16_hyper_vision/z_protect/加强绕路和不动扣分/train_log/Park_Env_True/run-train_log_Park_Env_True-tag-eval_episode_reward.csv'
mlp_file_path = 'E:/project/AI_Designer/PARL_01/examples/MADDPG_16_MLP_vision2/z_protect/train_log/Park_Env_True/run-train_log_Park_Env_True-tag-eval_episode_reward.csv'
...
plt.title('Smoothed Eval Episode Reward Curve Comparison: Hybrid vs MLP Networks', fontsize=14)
...
transparent_output_path = './smoothed_eval_episode_reward_curve_comparison_transparent.svg'
