...
mlp_file_path = 'E:/project/AI_Designer/PARL_01/examples/MADDPG_16_MLP_vision2/z_protect/train_log/Park_Env_True/run-train_log_Park_Env_True-tag-Loss_Critic_Loss.csv'
...
plt.title('Smoothed Loss Curve Comparison: Hybrid vs MLP Networks', fontsize=14)
...
transparent_output_path = './smoothed_loss_curve_comparison_transparent.svg'
