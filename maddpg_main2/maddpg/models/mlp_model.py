# mlp_model.py — Pure MLP model (no spatial processing)
import parl
import paddle
...
class MLPMAModel(parl.Model):
    def __init__(self,
        ...
        super(MLPMAModel, self).__init__()
...
class ActorModel(parl.Model):
    ...
    def forward(self, obs):
        ...
        means = self.fc3(hid2)
        if self.continuous_actions:
            # Do NOT apply tanh here: MADDPG.predict()/sample() applies tanh
