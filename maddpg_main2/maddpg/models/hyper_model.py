# hyper_model.py — CNN-MLP model for elevation map processing
import parl
import paddle
...
class HyperMAModel(parl.Model):
    def __init__(self,
        ...
        super(HyperMAModel, self).__init__()
        ...
        logger.info(f"critic_in_dim: {critic_in_dim}")
...
# Backward compatibility alias (checkpoint loading uses class name)
