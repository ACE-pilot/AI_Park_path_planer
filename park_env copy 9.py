...
class ParkEnv(gym.Env):
    ...
    def __init__(self, num_agents=3, render_mode=False):
        ...
        # 定义起点和终点的对象层标记值
        self.START_POINT_VALUE = 4
        self.END_POINT_VALUE = 5
    ...
    def _generate_map(self):
        ...
        try:
            ...
            self.map[2, y_start, x_start] = self.START_POINT_VALUE
            self.map[2, y_end, x_end] = self.END_POINT_VALUE
    ...
    def _move_agent(self, position, action):
        ...
        speed_scale = self.map_size * 0.1  # 控制移动速度的系数
